  ...
  inventoryData: [
    {
      ...
      description: "A set of high-quality stainless steel cookware including pots and pans.",
      price: 149.99,
      stock: 15,
      sku: "KITCH001",
    ...
    },
    {
      ...
      description: "A programmable electric coffee maker for brewing your favorite coffee.",
      price: 39.99,
      stock: 8,
      sku: "KITCH002",
      supplier: "BrewMaster Appliances",
      delivered: 2,
      imageUrl: "https://4.imimg.com/data4/NF/XX/MY-3554754/electric-coffee-maker-500x500.jpg",
    },
    {
      id: 3,
      department: "Clothing",
      ...
      delivered: 10,
      imageUrl: "https://4.imimg.com/data4/KS/HD/MY-718120/mens-casual-t-shirts-500x500.jpg",
    },
    {
      id: 4,
      department: "Clothing",
    ...
    },
    {
      ...
      description: "A set of colorful building blocks for creative play and learning.",
      price: 24.95,
      stock: 25,
      sku: "TOYS001",
      supplier: "PlayfulMinds Toys",
      delivered: 5,
      imageUrl: "https://smalltub.com/products/main/15451427001539408762Building-Blocks-Set1A.jpg",
    },
    {
      id: 6,
      department: "Toys",
      name: "Remote Control Car",
      description: "A fun remote control car with realistic features and controls.",
      price: 49.99,
      stock: 12,
      sku: "TOYS002",
    ...
    },
    {
      ...
      description: "A durable non-stick frying pan for easy cooking and cleaning.",
      price: 29.95,
      stock: 20,
      sku: "KITCH003",
      supplier: "CookEase Essentials",
      delivered: 10,
      imageUrl: "https://www.anko.co.in/cdn/shop/products/71yIQACoAiL.jpg?v=1687520426",
    },
    {
      id: 8,
      department: "Clothing",
    ...
    },
    {
      ...
      description: "A powerful blender with multiple speed settings for various blending tasks.",
      price: 69.99,
      stock: 10,
      sku: "KITCH004",
      supplier: "BlendMaster Appliances",
      delivered: 10,
      imageUrl: "https://m.media-amazon.com/images/I/41dMtEjU3IL._AC_UF894,1000_QL80_.jpg",
    },
  ],
...
const ShowLowStock = "ShowLowStock";
const SortProducts = "SortProducts";
const UpdateProductList = "UpdateProductList";

export { appInitialState, FilterProducts, ShowLowStock, SortProducts, UpdateProductList };
